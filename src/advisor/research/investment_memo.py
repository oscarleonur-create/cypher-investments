    ...
    try:
        ...
        result = llm.complete(
            system_prompt=(
                ...
                "max_loss_scenario: 2 sentences — if we are completely wrong, "
                "what is the worst case. "
                "bear_case_deep_dive: 3–4 sentences expanding on the bear thesis. "
                "exit_triggers: 4–6 specific, measurable conditions that would "
                "force a position review. "
                "Be precise. Use numbers when possible. No marketing language."
            ),
            user_prompt=context,
