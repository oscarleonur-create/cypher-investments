"""The blank thesis template, mirrored from the frontend.

Kept here so `detect.py` can tell an untouched form from a written thesis
by comparing against the real thing rather than guessing at phrases. The
frontend copy in `frontend/src/lib/thesisTemplate.ts` remains the one the
editor inserts; a test asserts the two have not drifted apart.
"""

from __future__ import annotations

TEMPLATE = """# <one-line thesis>
